...
def solve_problem():
    ...
    C = k / h / h  # alpha = k/h^2, pro snazší zápis zvoleno C
    ...
    # ... kk prvním a posledním řádkům je ještě přičten tento výraz (vyjadřující známé hodnoty pro i=0, i=n)
    b[(0, -1), 0] += C / 2

    # nyní je vyřešena soustava rovnic a sestaven nový řádek u[j+1, :]
    u_new = solve(A, b)

    u_final[1, (0, -1)] = 1  # okrajové hondoty známe z okrajové podmínky
    u_final[1, 1:-1] = u_new.T  # prostřední hodnoty z řešení soustavy rovnic
    print(u_final)
